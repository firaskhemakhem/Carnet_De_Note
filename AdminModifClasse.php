                        ...
                        <div class="modifier">
                            <fieldset>
                                ...
                                <table>
                                    ...
                                    <table>
                                        <tr>
                                            <td><div class="envoi"><input type="submit" name="ModifClasse" value="Enregistrer" class="btn btn-primary" id="btnsecondaire"/></div></td>
                                            <td><div classe="envoi1"><input type="submit" name="ModifClasse" value="Annuler" class="btn btn-primary" id="btnsecondaire"></div></td>
                                        </tr>
                                    </table>       
                            </fieldset>
                        </div>
